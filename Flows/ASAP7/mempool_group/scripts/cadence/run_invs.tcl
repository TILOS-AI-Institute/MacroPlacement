...
if {[info exist ::env(PHY_SYNTH)] && $::env(PHY_SYNTH) == 1} {
    ...
    # To evaluate manual macro placement uncomment the following line
    # source place_mempool_macros.tcl
    source ../../../../util/gen_pb.tcl
    gen_pb_netlist
} else {
    defIn $floorplan_def
    addHaloToBlock -allMacro $HALO_WIDTH $HALO_WIDTH $HALO_WIDTH $HALO_WIDTH
    # floorPlan -r 1.0 0.68 2 2 2 2
    place_design -concurrent_macros
    refine_macro_place
}

source mempool_group_place_pin.tcl
