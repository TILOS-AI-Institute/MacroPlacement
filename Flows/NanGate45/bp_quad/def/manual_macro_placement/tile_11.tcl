...
#-------------------------------------------------------------------------------
set TILE y_1__x_1
set tile_orig_x [expr $fp_lly + $fp_x_offset + 4*(6*$l2_data_size_x + 3*$spacing_x) - $l2_data_size_x]
set tile_orig_y [expr $fp_ury - $fp_y_offset]


#---------------------------------------
# L2 cache data (mirroed)
#---------------------------------------
#     00  01-10  11-20  21
#     30  31-40  41-50  51
#     60  61-70  71
...
set tag_x [expr $x - $tag_size_x - $spacing_x]
...
set orig_x [expr $tile_orig_x + $l2_data_size_x - $size_x]
...
set x [expr $ref_ram_llx - $size_x - $spacing_x]
...
for {set i 0} {$i < 2} {incr i} {
    if {$i == 1} {
        ...
        set orig_x [expr $ref_ram_llx - $size_x - $spacing_x]
