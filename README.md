...
## **Our Latest Progress**
 ...
 - Our [Code Elements](https://github.com/TILOS-AI-Institute/MacroPlacement/tree/main/Docs/CodeElements) documentation gives implementation details to enable reproduction of the gridding, gruoping and clustering used by [Circuit Training](https://github.com/google-research/circuit_training).
